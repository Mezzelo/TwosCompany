...
namespace TwosCompany.Helper {
    ...
    public static class ManifHelper {
        ...
        public static Dictionary<string, string> cardTexts = new Dictionary<string, string> {
            ...
            {"CouchB", "Deal <c=hurt>damage</c> equal to <c=keyword>double</c> distance moved since drawing this card{0}."},
            ...
            {"Outmaneuver", "Gain <c=keyword>{0}</c> <c=status>evade for every incoming attack currently targeting your ship{1}."},
            {"OutmaneuverA", "Gain <c=keyword>{0}</c> <c=status>evade for every incoming attack currently targeting your ship{1}."},
            {"OutmaneuverB", "Gain <c=keyword>{0}</c> <c=status>evade for every incoming attack currently targeting your ship{1}."},
