...
namespace TwosCompany.Helper {
    ...
    public static class ManifHelper {
        ...
        public static Dictionary<string, string> cardTexts = new Dictionary<string, string> {
            ...
            {"Remise", "<c=cardtrait>X</c> = <c=cardtrait># of enemy attacks</c>. Gain <c=status>{0} evade</c>, fire for <c=hurt>{0}</c> dmg."},
            {"RemiseA", "<c=cardtrait>X</c> = <c=cardtrait># of enemy attacks</c>. Gain <c=status>{0} evade</c>, fire for <c=hurt>{0}</c> dmg."},
            {"RemiseB", "<c=cardtrait>X</c> = <c=cardtrait># of enemy attacks</c>. Gain <c=status>{0} evade</c>, fire <c=hurt>{0}</c> times."},
