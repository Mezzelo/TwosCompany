...
namespace TwosCompany.Helper {
    ...
    public static class ManifHelper {
        ...
        public static Dictionary<string, string> cardTexts = new Dictionary<string, string> {
            ...
            {"ForesightA", "Choose <c=keyword>4</c> cards in your <c=keyword>draw pile</c> to <c=keyword>discard</c>. Draw <c=keyword>2</c>."},
            ...
            {"LetLooseA", "Draw <c=keyword>1</c> card. Temporarily reduce the cost of your entire hand by <c=energy>1</c>."},
            ...
            {"RuminateA", "Move <c=keyword>2</c> cards to top of draw pile. Draw <c=keyword>1</c> more next turn. <c=downside>End turn.</c>"},
