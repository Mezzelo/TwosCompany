...
namespace TwosCompany.ModBG {
    public class BGCoreEmpty : BG {
        ...
        public override void Render(G g, double t, Vec offset) {
            ...
            Draw.Sprite(Enum.Parse<Spr>("bg_cobaltChamber_bg"), 0.0, 0.0);
            Spr? id = Enum.Parse<Spr>("bg_cobaltChamber_crystal_glow");
            ...
            Draw.Sprite(Enum.Parse<Spr>("bg_cobaltChamber_room_outer"), 0.0, 0.0);
            Spr? id5 = Enum.Parse<Spr>("bg_cobaltChamber_glass");
            color3 = value;
