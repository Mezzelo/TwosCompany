namespace TwosCompany.ModBG {
    public class BGShipyard : BG {
        ...
        public override void Render(G g, double t, Vec offset) {
            ...
            Spr? id = StableSpr.bg_space_station_alt;
            Color? color2 = color;
            ...
            Spr? id5 = StableSpr.bg_shipyard_platform;
